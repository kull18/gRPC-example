...
func (x *SaveUserRequest) GetId() int32 {
	if x != nil {
		return x.Id
	}
	return 0
...
const file_user_proto_rawDesc = "" +
	...
	"\vUserService\x129\n" +
	"\bSaveUser\x12\x15.user.SaveUserRequest\x1a\x16.user.SaveUserResponseB\x1aZ\x18gRPC-example/proto;protob\x06proto3"
...
var file_user_proto_depIdxs = []int32{
	...
	1, // 1: user.UserService.SaveUser:output_type -> user.SaveUserResponse
